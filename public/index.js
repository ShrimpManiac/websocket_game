...
// 아이템
const ITEM_CONFIG = [
  { width: 50 / 1.5, height: 50 / 1.5, id: 2000, image: 'images/items/pokeball_red.png' },
  { width: 50 / 1.5, height: 50 / 1.5, id: 2001, image: 'images/items/pokeball_yellow.png' },
  { width: 50 / 1.5, height: 50 / 1.5, id: 2002, image: 'images/items/pokeball_purple.png' },
  { width: 50 / 1.5, height: 50 / 1.5, id: 2003, image: 'images/items/pokeball_cyan.png' },
];
...
function gameLoop(currentTime) {
  ...
  if (!gameover && !waitingToStart) {
    ...
    itemController.update(gameSpeed, deltaTime, score.getStage());
    // 달리기
